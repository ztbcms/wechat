        ...
        new Vue({
            ...
            methods: {
                getQrcode: function () {
                    ...
                    this.httpGet("{:api_url('/wechat/login.OfficeWebScanLogin/getLoginCode')}", {
                        appid: this.appid,
                    }, function (res) {
                        if (res.status) {
                            that.code = res.data.login_code
                            ...
                            that.status = 3
                            let qrcode_url = res.data.qrcode_url
                ...
                checkCode: function () {
                    if (!this.code) return
                    let that = this
                    this.httpGet("{:api_url('/wechat/login.OfficeWebScanLogin/checkCode')}", {code: this.code}, function (res) {
                        if (res.status) {
                            if (res.data.token === '') {
                                that.status = 5
                                return
