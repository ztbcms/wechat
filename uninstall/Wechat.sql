DROP TABLE IF EXISTS `cms_wechat_application`;
DROP TABLE IF EXISTS `cms_wechat_auth_token`;
DROP TABLE IF EXISTS `cms_wechat_office_user`;
DROP TABLE IF EXISTS `cms_wechat_office_template`;
DROP TABLE IF EXISTS `cms_wechat_office_template_send_record`;
...
DROP TABLE IF EXISTS `cms_wechat_mini_live_playback`;
...
DROP TABLE IF EXISTS `cms_wechat_open_app`;
DROP TABLE IF EXISTS `cms_wechat_open_event`;
